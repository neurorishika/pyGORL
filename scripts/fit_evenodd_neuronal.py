...
parser.add_argument('--output', default='processed_data/dmData_14-09-2023/', type=str,
...
# Dump to disk
with gzip.open(args.output+'fit_results/neuronal_fit_results.pkl.gz', 'wb') as f:
